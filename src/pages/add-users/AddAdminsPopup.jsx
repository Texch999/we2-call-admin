...
//             {props.adminsData ? "Update" : "Create"}
//           </Button>
//         </Form>
//       </Modal.Body>
//     </Modal>
...
import { IoEyeSharp, IoEyeOffSharp } from "react-icons/io5";
import { call } from "../../config/axios";
import { ACCOUNT_REGISTERATION ,UPDATE_USER_ADMIN} from "../../config/endpoints";
...
function AddAdminsPopup(props) {
  ...
  const handleUpdateUserAdmin = async () => {
      ...
      // Make the API call to update the user/admin data
  ...
  console.log(props.adminsData, ".........addadminsdata");
  return (
    <Modal {...props} centered className="add-user-modal" onHide={()=>{
      setInputData({})
      ...
      <Modal.Body>
        <Form className="add-user-modal-form-details">
          ...
          <Button
            ...
            onClick={() => {
              if (props.adminsData) {
                console.log("Props Data===>",props.adminsData)
                // If adminsData is present, update the user/admin
                handleUpdateUserAdmin();
              } else {
                // Otherwise, create a new user/admin
                handleSubmitUserCreation();
              }
            }}
          >
            {console.log(props.adminsData,props.adminsData ? "Update" : "Create","props.adminsData")}
            {/* {isProcessing ? "Processing..." : "Add"} */}
               { Object.keys(props.adminsData).length>0 ? "Update" : "Create"}
          </Button>
        </Form>
      </Modal.Body>
    </Modal>
