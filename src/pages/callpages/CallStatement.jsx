    ...
    <div className="we-2-call-homepage h-100vh">
      <div className="main-div">
        ...
        <div className="flex-row flex-space-around w-60 mb-20">
          <div className="details-btn w-60 h-7vh br-10 flex-space-around flex-column align-baseline p-5 mr-10 ml-10">
            <div className="font-16 flex-start">
              Settlement Information Charges
            </div>
            <div className="clr-yellow font-16 fw-600">1000/Hour</div>
          </div>
          <div className="details-btn w-30 h-7vh br-10 flex-space-around flex-column align-baseline p-5  mr-10 ml-10">
            ...
            <div className="clr-yellow font-16 fw-600">159h 59m 32s</div>
          </div>
          <div className="details-btn w-30 h-7vh br-10 flex-space-around flex-column align-baseline p-5 mr-10 ml-10">
            <div className="font-16">Total Amount</div>
            <div className="clr-yellow font-16 fw-600">15970</div>
          </div>
        </div>
