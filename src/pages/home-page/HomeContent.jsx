      ...
      <div className="row vh-50 p-3">
        <div className="col-7 call-management col-sm-12 col-md-12 col-lg-7 col-xl-7 d-flex">
          ...
          <div className="w-50 d-flex align-items-center justify-content-center">
            <img className="call-management-image" src={Images.headphone_with_microphone}></img>
          </div>
        </div>
        <div className="col-5 col-sm-12 col-md-12 col-lg-5 col-xl-5 management">
          <div className="user-management  d-flex p-3">
            <div >
              <img className="management-image" src={Images.SportManagement}></img>
            </div>
          </div>
          <div className="sports-management h-50 p-3">
            <div>
