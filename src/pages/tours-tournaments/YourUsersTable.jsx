...
function YourUsersTable() {
  const TOUR_USERS_DETAILS = [
    {
      id: 1,
      sNo: 1,
      date: "01/08/2023",
  ...
  return (
    <div className="common-container mt-2">
      ...
      <div className="meeting-content">
        {TOUR_USERS_DETAILS?.map((item, index) => (
      ...
      // </div> */}
      {/* // <Table data={TOUR_USERS_DETAILS} columns={TOUR_USERS_HEAD}/> */}
      <Table data={TOUR_USERS_DETAILS} columns={TOUR_USERS_HEAD}/>
    </div>
  );
}

export default YourUsersTable;
