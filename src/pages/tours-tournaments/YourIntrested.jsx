...
function YourIntrested(props) {
  ...
  return (
    <div>
      ...
      {tourdetailsAddedMembers && tourdetailsAddedMembers.length > 0 ? (
        tourdetailsAddedMembers.map((item) => {
          return (
            <div>
              <div className="p-1 font-14 fw-600 title-color">
                {item.tour_title}
              </div>
              <div className="p-1 font-12">{item.tour_details}</div>
